...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex min-h-[200vh] shrink-0 transform flex-col items-center justify-start py-0 [perspective:800px]",
        size === "large"
          ? (title === null ? "scale-[0.45] sm:scale-[0.6] md:scale-110 lg:scale-125 md:pt-96 md:pb-72" : "scale-[0.45] sm:scale-[0.6] md:scale-110 lg:scale-125 md:py-72")
          : size === "small"
          ? (title === null ? "scale-[0.3] sm:scale-[0.45] md:scale-[0.8] lg:scale-[0.85] md:pt-72 md:pb-48" : "scale-[0.3] sm:scale-[0.45] md:scale-[0.8] lg:scale-[0.85] md:py-48")
          : (title === null ? "scale-[0.35] sm:scale-50 md:scale-100 md:pt-96 md:pb-80" : "scale-[0.35] sm:scale-50 md:scale-100 md:py-80")
      )}
    >
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {children ? (
          <div className="absolute inset-0 rounded-lg overflow-hidden overflow-y-auto bg-neutral-950 p-4">
            {children}
          </div>
        ) : src ? (
          <img
  ...
  return (
    <div
      className={cn(
        ...
        backlit && "bg-white/[0.12] border border-white/10 shadow-[0_0_2px_rgba(255,255,255,0.25)]",
      )}
    >
      <div
        className={cn(
